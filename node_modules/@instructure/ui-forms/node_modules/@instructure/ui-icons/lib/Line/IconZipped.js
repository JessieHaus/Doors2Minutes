...
var IconZipped = (_temp = _class = function (_Component) {
  _inherits(IconZipped, _Component);

  function IconZipped() {
    _classCallCheck(this, IconZipped);

    return _possibleConstructorReturn(this, (IconZipped.__proto__ || Object.getPrototypeOf(IconZipped)).apply(this, arguments));
  }

  _createClass(IconZipped, [{
    key: 'render',
