...
var IconSpeedGrader = (_temp = _class = function (_Component) {
  _inherits(IconSpeedGrader, _Component);

  function IconSpeedGrader() {
    _classCallCheck(this, IconSpeedGrader);

    return _possibleConstructorReturn(this, (IconSpeedGrader.__proto__ || Object.getPrototypeOf(IconSpeedGrader)).apply(this, arguments));
  }

  _createClass(IconSpeedGrader, [{
    key: 'render',
