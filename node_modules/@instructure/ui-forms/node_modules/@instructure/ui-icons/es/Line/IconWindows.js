...
var IconWindows = (_temp = _class = function (_Component) {
  _inherits(IconWindows, _Component);

  function IconWindows() {
    _classCallCheck(this, IconWindows);

    return _possibleConstructorReturn(this, (IconWindows.__proto__ || Object.getPrototypeOf(IconWindows)).apply(this, arguments));
  }

  _createClass(IconWindows, [{
    key: 'render',
  ...
  ;
  return IconWindows;
}(Component), _class.glyphName = 'windows', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconWindows as default };