...
var IconStarLight = (_temp = _class = function (_Component) {
  _inherits(IconStarLight, _Component);

  function IconStarLight() {
    _classCallCheck(this, IconStarLight);

    return _possibleConstructorReturn(this, (IconStarLight.__proto__ || Object.getPrototypeOf(IconStarLight)).apply(this, arguments));
  }

  _createClass(IconStarLight, [{
    key: 'render',
