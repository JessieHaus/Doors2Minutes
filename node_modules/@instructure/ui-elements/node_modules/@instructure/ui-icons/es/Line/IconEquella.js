...
var IconEquella = (_temp = _class = function (_Component) {
  _inherits(IconEquella, _Component);

  function IconEquella() {
    _classCallCheck(this, IconEquella);

    return _possibleConstructorReturn(this, (IconEquella.__proto__ || Object.getPrototypeOf(IconEquella)).apply(this, arguments));
  }

  _createClass(IconEquella, [{
    key: 'render',
