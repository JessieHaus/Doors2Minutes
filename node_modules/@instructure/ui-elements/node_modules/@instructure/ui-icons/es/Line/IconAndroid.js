...
var IconAndroid = (_temp = _class = function (_Component) {
  _inherits(IconAndroid, _Component);

  function IconAndroid() {
    _classCallCheck(this, IconAndroid);

    return _possibleConstructorReturn(this, (IconAndroid.__proto__ || Object.getPrototypeOf(IconAndroid)).apply(this, arguments));
  }

  _createClass(IconAndroid, [{
    key: 'render',
  ...
  ;
  return IconAndroid;
}(Component), _class.glyphName = 'android', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
