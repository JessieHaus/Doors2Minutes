...
var IconWordpress = (_temp = _class = function (_Component) {
  _inherits(IconWordpress, _Component);

  function IconWordpress() {
    _classCallCheck(this, IconWordpress);

    return _possibleConstructorReturn(this, (IconWordpress.__proto__ || Object.getPrototypeOf(IconWordpress)).apply(this, arguments));
  }

  _createClass(IconWordpress, [{
    key: 'render',
