...
var IconTwitterBoxed = (_temp = _class = function (_Component) {
  _inherits(IconTwitterBoxed, _Component);

  function IconTwitterBoxed() {
    _classCallCheck(this, IconTwitterBoxed);

    return _possibleConstructorReturn(this, (IconTwitterBoxed.__proto__ || Object.getPrototypeOf(IconTwitterBoxed)).apply(this, arguments));
  }

  _createClass(IconTwitterBoxed, [{
    key: 'render',
    value: function render() {

      if (process.env.NODE_ENV !== 'production') {
        console.warn('<IconTwitterBoxed /> is deprecated. Please use <IconTwitter /> instead.');
      }
