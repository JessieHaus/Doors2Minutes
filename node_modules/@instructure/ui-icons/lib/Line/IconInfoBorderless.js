...
var IconInfoBorderless = (_temp = _class = function (_Component) {
  _inherits(IconInfoBorderless, _Component);

  function IconInfoBorderless() {
    _classCallCheck(this, IconInfoBorderless);

    return _possibleConstructorReturn(this, (IconInfoBorderless.__proto__ || Object.getPrototypeOf(IconInfoBorderless)).apply(this, arguments));
  }

  _createClass(IconInfoBorderless, [{
    key: 'render',
