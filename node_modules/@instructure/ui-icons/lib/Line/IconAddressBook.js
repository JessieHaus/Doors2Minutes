...
var IconAddressBook = (_temp = _class = function (_Component) {
  _inherits(IconAddressBook, _Component);

  function IconAddressBook() {
    _classCallCheck(this, IconAddressBook);

    return _possibleConstructorReturn(this, (IconAddressBook.__proto__ || Object.getPrototypeOf(IconAddressBook)).apply(this, arguments));
  }

  _createClass(IconAddressBook, [{
    key: 'render',
...
}(_react.Component), _class.glyphName = 'address-book', _class.variant = 'Line', _class.propTypes = Object.assign({}, _SVGIcon2.default.propTypes), _temp);
