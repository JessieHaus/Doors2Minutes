...
var IconModule = (_temp = _class = function (_Component) {
  _inherits(IconModule, _Component);

  function IconModule() {
    _classCallCheck(this, IconModule);

    return _possibleConstructorReturn(this, (IconModule.__proto__ || Object.getPrototypeOf(IconModule)).apply(this, arguments));
  }

  _createClass(IconModule, [{
    key: 'render',
