...
var IconNoteLight = (_temp = _class = function (_Component) {
  _inherits(IconNoteLight, _Component);

  function IconNoteLight() {
    _classCallCheck(this, IconNoteLight);

    return _possibleConstructorReturn(this, (IconNoteLight.__proto__ || Object.getPrototypeOf(IconNoteLight)).apply(this, arguments));
  }

  _createClass(IconNoteLight, [{
    key: 'render',
    value: function render() {

      if (process.env.NODE_ENV !== 'production') {
        console.warn('<IconNoteLight /> is deprecated. Please use <IconNote /> instead.');
      }
  ...
  IconNoteLight.displayName = 'IconNoteLight'
  ;
  return IconNoteLight;
}(_react.Component), _class.glyphName = 'note-light', _class.variant = 'Solid', _class.deprecated = true, _class.propTypes = Object.assign({}, _SVGIcon2.default.propTypes), _temp);
exports.default = IconNoteLight;