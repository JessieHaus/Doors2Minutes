...
var IconEssay = (_temp = _class = function (_Component) {
  _inherits(IconEssay, _Component);

  function IconEssay() {
    _classCallCheck(this, IconEssay);

    return _possibleConstructorReturn(this, (IconEssay.__proto__ || Object.getPrototypeOf(IconEssay)).apply(this, arguments));
  }

  _createClass(IconEssay, [{
    key: 'render',
