...
var IconNote = (_temp = _class = function (_Component) {
  _inherits(IconNote, _Component);

  function IconNote() {
    _classCallCheck(this, IconNote);

    return _possibleConstructorReturn(this, (IconNote.__proto__ || Object.getPrototypeOf(IconNote)).apply(this, arguments));
  }

  _createClass(IconNote, [{
    key: 'render',
  ...
  ;
  return IconNote;
}(Component), _class.glyphName = 'note', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
