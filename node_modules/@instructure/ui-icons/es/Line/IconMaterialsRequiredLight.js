...
var IconMaterialsRequiredLight = (_temp = _class = function (_Component) {
  _inherits(IconMaterialsRequiredLight, _Component);

  function IconMaterialsRequiredLight() {
    _classCallCheck(this, IconMaterialsRequiredLight);

    return _possibleConstructorReturn(this, (IconMaterialsRequiredLight.__proto__ || Object.getPrototypeOf(IconMaterialsRequiredLight)).apply(this, arguments));
  }

  _createClass(IconMaterialsRequiredLight, [{
    key: 'render',
    value: function render() {

      if (process.env.NODE_ENV !== 'production') {
        console.warn('<IconMaterialsRequiredLight /> is deprecated. Please use <IconMaterialsRequired /> instead.');
      }
