...
var IconLifePreserver = (_temp = _class = function (_Component) {
  _inherits(IconLifePreserver, _Component);

  function IconLifePreserver() {
    _classCallCheck(this, IconLifePreserver);

    return _possibleConstructorReturn(this, (IconLifePreserver.__proto__ || Object.getPrototypeOf(IconLifePreserver)).apply(this, arguments));
  }

  _createClass(IconLifePreserver, [{
    key: 'render',
...
}(Component), _class.glyphName = 'life-preserver', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconLifePreserver as default };