...
var IconTwitter = (_temp = _class = function (_Component) {
  _inherits(IconTwitter, _Component);

  function IconTwitter() {
    _classCallCheck(this, IconTwitter);

    return _possibleConstructorReturn(this, (IconTwitter.__proto__ || Object.getPrototypeOf(IconTwitter)).apply(this, arguments));
  }

  _createClass(IconTwitter, [{
    key: 'render',
  ...
  ;
  return IconTwitter;
}(Component), _class.glyphName = 'twitter', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
