...
var IconMaterialsRequired = (_temp = _class = function (_Component) {
  _inherits(IconMaterialsRequired, _Component);

  function IconMaterialsRequired() {
    _classCallCheck(this, IconMaterialsRequired);

    return _possibleConstructorReturn(this, (IconMaterialsRequired.__proto__ || Object.getPrototypeOf(IconMaterialsRequired)).apply(this, arguments));
  }

  _createClass(IconMaterialsRequired, [{
    key: 'render',
  ...
  IconMaterialsRequired.displayName = 'IconMaterialsRequired'
  ;
  return IconMaterialsRequired;
}(Component), _class.glyphName = 'materials-required', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconMaterialsRequired as default };