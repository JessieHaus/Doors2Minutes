...
var IconTarget = (_temp = _class = function (_Component) {
  _inherits(IconTarget, _Component);

  function IconTarget() {
    _classCallCheck(this, IconTarget);

    return _possibleConstructorReturn(this, (IconTarget.__proto__ || Object.getPrototypeOf(IconTarget)).apply(this, arguments));
  }

  _createClass(IconTarget, [{
    key: 'render',
  ...
  ;
  return IconTarget;
}(Component), _class.glyphName = 'target', _class.variant = 'Solid', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
