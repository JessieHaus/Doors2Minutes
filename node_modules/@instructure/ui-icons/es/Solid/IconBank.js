...
var IconBank = (_temp = _class = function (_Component) {
  _inherits(IconBank, _Component);

  function IconBank() {
    _classCallCheck(this, IconBank);

    return _possibleConstructorReturn(this, (IconBank.__proto__ || Object.getPrototypeOf(IconBank)).apply(this, arguments));
  }

  _createClass(IconBank, [{
    key: 'render',
  ...
  ;
  return IconBank;
}(Component), _class.glyphName = 'bank', _class.variant = 'Solid', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconBank as default };