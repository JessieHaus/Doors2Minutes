...
var IconPostToSis = (_temp = _class = function (_Component) {
  _inherits(IconPostToSis, _Component);

  function IconPostToSis() {
    _classCallCheck(this, IconPostToSis);

    return _possibleConstructorReturn(this, (IconPostToSis.__proto__ || Object.getPrototypeOf(IconPostToSis)).apply(this, arguments));
  }

  _createClass(IconPostToSis, [{
    key: 'render',
