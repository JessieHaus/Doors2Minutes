...
var IconRss = (_temp = _class = function (_Component) {
  _inherits(IconRss, _Component);

  function IconRss() {
    _classCallCheck(this, IconRss);

    return _possibleConstructorReturn(this, (IconRss.__proto__ || Object.getPrototypeOf(IconRss)).apply(this, arguments));
  }

  _createClass(IconRss, [{
    key: 'render',
  ...
  ;
  return IconRss;
}(_react.Component), _class.glyphName = 'rss', _class.variant = 'Line', _class.propTypes = Object.assign({}, _SVGIcon2.default.propTypes), _temp);
