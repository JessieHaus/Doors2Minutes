...
var IconDeactivateUser = (_temp = _class = function (_Component) {
  _inherits(IconDeactivateUser, _Component);

  function IconDeactivateUser() {
    _classCallCheck(this, IconDeactivateUser);

    return _possibleConstructorReturn(this, (IconDeactivateUser.__proto__ || Object.getPrototypeOf(IconDeactivateUser)).apply(this, arguments));
  }

  _createClass(IconDeactivateUser, [{
    key: 'render',
