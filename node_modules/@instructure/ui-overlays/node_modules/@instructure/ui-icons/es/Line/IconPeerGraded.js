...
var IconPeerGraded = (_temp = _class = function (_Component) {
  _inherits(IconPeerGraded, _Component);

  function IconPeerGraded() {
    _classCallCheck(this, IconPeerGraded);

    return _possibleConstructorReturn(this, (IconPeerGraded.__proto__ || Object.getPrototypeOf(IconPeerGraded)).apply(this, arguments));
  }

  _createClass(IconPeerGraded, [{
    key: 'render',
