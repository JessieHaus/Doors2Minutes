...
var IconGithub = (_temp = _class = function (_Component) {
  _inherits(IconGithub, _Component);

  function IconGithub() {
    _classCallCheck(this, IconGithub);

    return _possibleConstructorReturn(this, (IconGithub.__proto__ || Object.getPrototypeOf(IconGithub)).apply(this, arguments));
  }

  _createClass(IconGithub, [{
    key: 'render',
  ...
  ;
  return IconGithub;
}(Component), _class.glyphName = 'github', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
