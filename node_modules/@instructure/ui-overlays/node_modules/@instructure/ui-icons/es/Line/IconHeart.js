...
var IconHeart = (_temp = _class = function (_Component) {
  _inherits(IconHeart, _Component);

  function IconHeart() {
    _classCallCheck(this, IconHeart);

    return _possibleConstructorReturn(this, (IconHeart.__proto__ || Object.getPrototypeOf(IconHeart)).apply(this, arguments));
  }

  _createClass(IconHeart, [{
    key: 'render',
  ...
  ;
  return IconHeart;
}(Component), _class.glyphName = 'heart', _class.variant = 'Line', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
