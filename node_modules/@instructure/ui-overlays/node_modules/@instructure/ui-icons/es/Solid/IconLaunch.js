...
var IconLaunch = (_temp = _class = function (_Component) {
  _inherits(IconLaunch, _Component);

  function IconLaunch() {
    _classCallCheck(this, IconLaunch);

    return _possibleConstructorReturn(this, (IconLaunch.__proto__ || Object.getPrototypeOf(IconLaunch)).apply(this, arguments));
  }

  _createClass(IconLaunch, [{
    key: 'render',
  ...
  ;
  return IconLaunch;
}(Component), _class.glyphName = 'launch', _class.variant = 'Solid', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
