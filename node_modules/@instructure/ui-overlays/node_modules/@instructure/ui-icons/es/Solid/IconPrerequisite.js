...
var IconPrerequisite = (_temp = _class = function (_Component) {
  _inherits(IconPrerequisite, _Component);

  function IconPrerequisite() {
    _classCallCheck(this, IconPrerequisite);

    return _possibleConstructorReturn(this, (IconPrerequisite.__proto__ || Object.getPrototypeOf(IconPrerequisite)).apply(this, arguments));
  }

  _createClass(IconPrerequisite, [{
    key: 'render',
