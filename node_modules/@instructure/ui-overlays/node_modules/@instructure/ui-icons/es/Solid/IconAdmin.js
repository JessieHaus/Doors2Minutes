...
var IconAdmin = (_temp = _class = function (_Component) {
  _inherits(IconAdmin, _Component);

  function IconAdmin() {
    _classCallCheck(this, IconAdmin);

    return _possibleConstructorReturn(this, (IconAdmin.__proto__ || Object.getPrototypeOf(IconAdmin)).apply(this, arguments));
  }

  _createClass(IconAdmin, [{
    key: 'render',
  ...
  ;
  return IconAdmin;
}(Component), _class.glyphName = 'admin', _class.variant = 'Solid', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconAdmin as default };