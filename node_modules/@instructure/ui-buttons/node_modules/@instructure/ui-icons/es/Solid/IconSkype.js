...
var IconSkype = (_temp = _class = function (_Component) {
  _inherits(IconSkype, _Component);

  function IconSkype() {
    _classCallCheck(this, IconSkype);

    return _possibleConstructorReturn(this, (IconSkype.__proto__ || Object.getPrototypeOf(IconSkype)).apply(this, arguments));
  }

  _createClass(IconSkype, [{
    key: 'render',
  ...
  ;
  return IconSkype;
}(Component), _class.glyphName = 'skype', _class.variant = 'Solid', _class.propTypes = Object.assign({}, SVGIcon.propTypes), _temp);
export { IconSkype as default };