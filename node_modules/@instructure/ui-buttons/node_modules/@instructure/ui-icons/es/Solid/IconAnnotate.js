...
var IconAnnotate = (_temp = _class = function (_Component) {
  _inherits(IconAnnotate, _Component);

  function IconAnnotate() {
    _classCallCheck(this, IconAnnotate);

    return _possibleConstructorReturn(this, (IconAnnotate.__proto__ || Object.getPrototypeOf(IconAnnotate)).apply(this, arguments));
  }

  _createClass(IconAnnotate, [{
    key: 'render',
